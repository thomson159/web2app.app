...
const handleRawBody = rawBody => {
  // We want to split `rawBody` from the backend
...
// const unnestFrontmatter = backend => {
//   const { frontmatter, ...rest } = backend
...
// const handleRawBody = backend => {
//   // We want to split `rawBody` from the backend
//   const { rawBody, ...rest } = backend
